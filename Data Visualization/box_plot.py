...
def show_box_plot(data):
    ...
    fig, axes = plt.subplots(rows, columns_per_row, figsize=(20, 5 * rows), squeeze=False)
    ...
    for i, column in enumerate(numeric_columns):
        ...
        ax = axes[row][col]
        sns.boxplot(x='Hogwarts House', y=column, hue='Hogwarts House', data=data, 
                    ax=ax, palette=house_colors, dodge=False)
